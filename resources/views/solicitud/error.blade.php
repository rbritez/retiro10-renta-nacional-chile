...
<html lang="es">
  ...
  <body>
    ...
    <main id="pantallas-formulario"> 
      <div class="container">
        <div class="card card-mensaje" id="solicitud-error">
          <div class="card-body">
            ...
            <p>
              Estimado cliente,<br>
              Le informamos que <strong>ya ha realizado tu solicitud de anticipo.</strong><br>
              Le recordamos que la solicitud de anticipo se puede realizar una única vez.
            </p>
            {{-- @endif --}}
            <div class="botonera botonera-centrada"><a class="btn btn-primary" href="{{route('home.landing')}}">Ir al Inicio </a></div>
          </div>
        </div>
      </div>
    </main>
